...
def in1d(
    ...
    if (
        ...
        or isinstance(pda1, Strings)
        or isinstance(pda1, Categorical_)
    ):
    ...
    if (
        isinstance(pda2, pdarray)
        or isinstance(pda2, Strings)
        or isinstance(pda2, Categorical_)
    ):
        if pda2.size == 0:
    ...
    if hasattr(pda1, "categories"):
        ...
        repMsg = generic_msg(
            cmd="in1d", args="{} {} {}".format(pda1.name, pda2.name, invert)
        )
